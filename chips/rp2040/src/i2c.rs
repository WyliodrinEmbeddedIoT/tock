...
impl<'a> I2c<'a> {
    ...
    pub fn set_resets(&self, resets: &'a resets::Resets) {
        self.resets.set(resets);
    }

    fn reset(&self) {
        self.resets.map_or_else(
            || panic!("You should call set_resets before reset."),
    ...
    fn unreset(&self) {
        self.resets.map_or_else(
            || panic!("You should call set_resets before unreset."),
            |resets| match self.instance_num {
    ...
    fn set_baudrate(&self, baudrate: u32) -> u32 {
        ...
        let freq_in = self
            ...
            .expect("You should call set_clocks before set_baudrate.");
