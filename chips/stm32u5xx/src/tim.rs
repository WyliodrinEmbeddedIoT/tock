...
impl<'a> Tim2<'a> {
    ...
    pub fn start(&self) {
        ...
        let input_freq = unsafe { crate::rcc::get_freqs().pclk1_tim.unwrap() };
...
impl<'a> Pwm<'a> {
    ...
    fn start_pwm(
        ...
        let input_hz = unsafe { crate::rcc::get_freqs().pclk1_tim.unwrap() }.0 as usize;
...
impl<'a> hil::pwm::Pwm for Pwm<'a> {
    ...
    fn get_maximum_frequency_hz(&self) -> usize {
        unsafe { crate::rcc::get_freqs().pclk1_tim.unwrap() }.0 as usize
    }
