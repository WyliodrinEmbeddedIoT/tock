...
// This gets initialized once, at the end of `Rcc::init`, which is called at chip startup,
// therefore it will be available to every peripheral afterrwards
use core::mem::MaybeUninit;
static mut CLOCK_FREQS: MaybeUninit<Clocks> = MaybeUninit::uninit();

/// Get current clock frequencies
///
/// Note: must not be used before `Rcc::init`
...
pub struct Clocks {
    pub sys: Option<Hertz>,
    pub hclk1: Option<Hertz>,
    pub hclk2: Option<Hertz>,
    pub hclk3: Option<Hertz>,
    pub pclk1: Option<Hertz>,
    pub pclk2: Option<Hertz>,
    pub pclk3: Option<Hertz>,
    pub pclk1_tim: Option<Hertz>,
    pub pclk2_tim: Option<Hertz>,
...
impl Rcc {
    ...
    pub fn init(&self, config: RccConfig, pwr: &Pwr) {
        ...
        unsafe {
            CLOCK_FREQS = MaybeUninit::new(Clocks {
                sys: Some(sys_clk),
                hclk1: Some(hclk),
                hclk2: Some(hclk),
                hclk3: Some(hclk),
