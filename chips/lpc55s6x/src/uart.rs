...
use crate::clocks::{self, Clock, FrgClockSource};
use crate::flexcomm::{self, Flexcomm};
use crate::uart::FIFOSTAT::TXEMPTY;
...
impl Configure for Uart<'_> {
    fn configure(&self, params: Parameters) -> Result<(), ErrorCode> {
        ...
        clocks.setup_uart_clock(self.instance as u32, clock_source);
