...
// The sum of the output_buf and internal_buf is set to a multiple of 8192 bytes in order to avoid excessive
...
// [DEBUG_BUFFER_SPLIT, DEBUG_BUFFER_KBYTE * 8192) are used for internal_buf.
...
impl Component for DebugWriterComponent {
    ...
    unsafe fn finalize(self, _s: Self::StaticInput) -> Self::Output {
        let buf = static_init!(
            [u8; 8192 * DEBUG_BUFFER_KBYTE],
            [0; 8192 * DEBUG_BUFFER_KBYTE]
        );
